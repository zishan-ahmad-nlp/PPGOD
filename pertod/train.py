...
from dataset_ent import GPT21024Dataset 
...
def main():
    ...
    parser.add_argument("--output_dir",default='./output/epoch5', type=str, required=False, help="path to save evaluation results")
    parser.add_argument("--model_dir",default='./weights/epoch5', type=str, required=False, help="path to save trained model")
    ...
    parser.add_argument("--root_dir",default='./data/updated_data/gpt2_train_data', type=str, required=False, help="location of json dataset.")
    parser.add_argument("--test_dir",default='./data/updated_data/gpt2_test_data', type=str, required=False, help="location of test json dataset.")
